...
export default class Sketch {
		...
		this.gltf.load(model, (gltf) =>{ 
			...
			this.model.traverse(child => {
				if(child.isMesh) {
					...
					let mesh = new THREE.Points(geo, this.material)
	...
	addObjects() {
		...
		this.geometry = new THREE.PlaneGeometry(1,2.2,1,1)
	...
	mouseEvent() {
		...
		window.addEventListener('mousemove', onMouseEv, false)
	}
